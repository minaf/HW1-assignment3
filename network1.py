...
# Use gradient descent with a lear0ning rate of .01
learning_rate = .01
...
name_lt = 'network1/loss/training/net1_t('+str(learning_rate)+','+str(nbatch)+str(n_iter)+').csv'
myfile_lt = open(name_lt,'w')
name_lv = 'network1/loss/validation/net1_v('+str(learning_rate)+','+str(nbatch)+str(n_iter)+').csv'
